...
const AGB_SECTIONS: Section[] = [
  { title: '1. Geltungsbereich', body: <p>Diese Allgemeinen Geschäftsbedingungen (AGB) gelten für sämtliche Verträge zwischen der {CONTACT_INFO.companyName} (nachfolgend «Unternehmer») und ihren Kundinnen und Kunden (nachfolgend «Auftraggeber») über Bau-, Renovierungs-, Maler-, Boden-, Fliesen-, Fassaden-, Abbruch-, Rückbau- und Reinigungsarbeiten. Abweichende Bedingungen des Auftraggebers gelten nur, wenn sie vom Unternehmer schriftlich bestätigt wurden.</p> },
